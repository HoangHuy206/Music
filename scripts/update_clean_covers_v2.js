...
async function run() {
  ...
  const cleanCovers = {
    'Chỉ Còn Những Mùa Nhớ (Tùng Nguyen Remix)': 'https://i1.sndcdn.com/artworks-000060098625-y7pb1s-t500x500.jpg',
    'Kiểu Gì Chẳng Mất (Huy PT x NVT Remix)': 'https://i1.sndcdn.com/artworks-yfSQe2QvNK1dlddk-M8ZebQ-t500x500.jpg',
    'Có Khi Nào Rời Xa (Remix 2020)': 'https://i1.sndcdn.com/artworks-vZAz5qa2oWEHyUhf-is8ptQ-t500x500.jpg',
    'Chân Tình Remix Lemon 2k': 'https://i1.sndcdn.com/artworks-JdzJQ3cyyUBLtgPo-7yt91g-t500x500.jpg',
    'Em Oi Len Pho (Lofi Vibe)': 'https://i1.sndcdn.com/artworks-000627358417-38osje-t500x500.jpg',
    'sao thay doi mi em buon': 'https://i1.sndcdn.com/artworks-85hXNjutcB4FfJy5-BEeOrg-t500x500.jpg',
  ...
  for (const [title, cover] of Object.entries(cleanCovers)) {
    await Song.updateOne({ title }, { $set: { coverImage: cover } });
  }

  console.log('Updated 18 songs in MongoDB:');
